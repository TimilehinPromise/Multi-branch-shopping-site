...
//        BigDecimal totalProfit = sellingPrice.subtract(product.getVendorPrice());
...
//                .status(this.status)
//                .productPrice(this.product.getVendorPrice())
...
//                .sellingPrice(decideSellingPrice(product))
...
//                .build();
//    }
//    public static BigDecimal decideSellingPrice(Product product){
//        if (product.isDiscounted()){
//            return product.getDiscountPrice();
//        }
//        else return product.getRetailPrice();
//    }
//}
